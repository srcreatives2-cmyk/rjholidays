...
const RJ_ARTICLE_CONTENT = {
  "kashmir-winter-guide": {
    "heroImg": "https://i.ibb.co/fzzLGzCk/Img-Kashmir.jpg",
  ...
  "triund-trek-guide": {
    "heroImg": "images/dest-dharamshala.jpg",
  ...
  "spiti-valley-road-trip": {
    "heroImg": "images/dest-himachal.jpg",
  ...
  "leh-ladakh-bike-trip": {
    "heroImg": "images/dest-ladakh.jpg",
  ...
  "best-time-manali": {
    "heroImg": "images/dest-manali.jpg",
  ...
  "sikkim-itinerary": {
    "heroImg": "images/dest-sikkim.jpg",
  ...
  "darjeeling-weekend": {
    "heroImg": "images/dest-darjeeling.jpg",
  ...
  "kashmir-honeymoon": {
    "heroImg": "images/dest-kashmir.jpg",
  ...
  function buildArticleBodyHTML(post, content, prevPost, nextPost) {
    ...
    return `
          ...
          <div class="author-box" id="author-box">
            <img src="${author.img}" alt="${post.author}, ${author.role}" loading="lazy" width="74" height="74" />
            <div>
              <h4>${post.author}</h4>
